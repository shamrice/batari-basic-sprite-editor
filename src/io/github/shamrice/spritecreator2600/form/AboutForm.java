...
public class AboutForm {
    ...
    public AboutForm() {
        ...
        aboutText += "\nsprite and playfield data. There is a visual grid where all cells that";
        aboutText += "\nare marked black will generate to a 1 or X and white cells will";
        aboutText += "\ngenerate to a 0 or . value. The generate code button takes care of";
